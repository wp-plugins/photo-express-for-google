...
(function (d, j, a) {
    ...
    d.Code.PhotoSwipe.Image.EventTypes = {onLoad: "onLoad", onError: "onError"}
})(window, window.klass, window.Code.Util);
(function (d, j, a) {
    a.registerNamespace("Code.PhotoSwipe.Image");
    var b = d.Code.PhotoSwipe;
    b.Image.ImageClass = j({
        refObj: null,
        imageEl: null,
        src: null,
        caption: null,
        ...
        initialize: function (a, f, b, i) {
            this.refObj = a;
            this.src = this.originalSrc = f;
            this.caption = b;
            this.metaData = i;
            this.imageEl = new d.Image;
...
(function (d, j, a) {
    ...
    d = d.Code.PhotoSwipe;
    d.Cache.Mode = {normal: "normal", aggressive: "aggressive"};
    d.Cache.Functions = {
        getImageSource: function (a) {
            ...
            var c, f, e;
            c = 0;
            for (f = b.childNodes.length; c < f; c++)if (e = b.childNodes[c], b.childNodes[c].nodeName === "IMG")return a.DOM.getAttribute(e, "alt")
...
(function (d, j, a) {
    a.registerNamespace("Code.PhotoSwipe.Cache");
    var b = d.Code.PhotoSwipe;
    b.Cache.CacheClass = j({
        images: null, settings: null, dispose: function () {
            var c, f, b;
            if (!a.isNothing(this.images)) {
                f = 0;
                for (b = this.images.length; f < b; f++)this.images[f].dispose();
            ...
            this.images = [];
            e = 0;
            for (d = a.length; e < d; e++)h = a[e], g = this.settings.getImageSource(h), k = this.settings.getImageCaption(h),
                j = this.settings.getImageMetaData(h), this.images.push(new b.Image.ImageClass(h, g, k, j))
        }, getImages: function (c) {
            var f, e, d = [], h;
            f = 0;
            for (e = c.length; f < e; f++) {
                h = this.images[c[f]];
                if (this.settings.cacheMode === b.Cache.Mode.aggressive)h.cacheDoNotShrink = !0;
                d.push(h)
            }
            if (this.settings.cacheMode === b.Cache.Mode.aggressive) {
                f = 0;
                for (e = this.images.length; f < e; f++)h = this.images[f], a.objectHasProperty(h, "cacheDoNotShrink") ? delete h.cacheDoNotShrink : h.shrinkImage()
            }
            return d
        }
    })
...
(function (d, j, a) {
    ...
    d.Code.PhotoSwipe.DocumentOverlay.CssClasses = {documentOverlay: "ps-document-overlay"}
})(window, window.klass, window.Code.Util);
(function (d, j, a) {
    a.registerNamespace("Code.PhotoSwipe.DocumentOverlay");
    var b = d.Code.PhotoSwipe;
    b.DocumentOverlay.DocumentOverlayClass = j({
        el: null, settings: null, initialBodyHeight: null, dispose: function () {
            ...
            a.DOM.hide(this.el);
            this.settings.target === d ? a.DOM.appendToBody(this.el) : a.DOM.appendChild(this.el, this.settings.target);
            a.Animation.resetTranslate(this.el);
            this.initialBodyHeight = a.DOM.bodyOuterHeight()
        }, resetPosition: function () {
            var c, f, b;
            if (this.settings.target === d) {
                c = a.DOM.windowWidth();
                f = a.DOM.bodyOuterHeight() * 2;
                b = this.settings.jQueryMobile ? a.DOM.windowScrollTop() + "px" : "0px";
                if (f < 1)f = this.initialBodyHeight;
                a.DOM.windowHeight() > f &&
                (f = a.DOM.windowHeight())
            } else c = a.DOM.width(this.settings.target), f = a.DOM.height(this.settings.target), b = "0px";
            a.DOM.setStyle(this.el, {width: c, height: f, top: b})
        }, fadeIn: function (c, f) {
            this.resetPosition();
            a.DOM.setStyle(this.el, "opacity", 0);
            a.DOM.show(this.el);
            a.Animation.fadeIn(this.el, c, f)
        }
    })
})(window, window.klass, window.Code.Util);
(function (d, j, a) {
    ...
    d = d.Code.PhotoSwipe;
    d.Carousel.EventTypes = {
        onSlideByEnd: "PhotoSwipeCarouselOnSlideByEnd",
        onSlideshowStart: "PhotoSwipeCarouselOnSlideshowStart",
        onSlideshowStop: "PhotoSwipeCarouselOnSlideshowStop"
    };
    d.Carousel.CssClasses = {
    ...
    d.Carousel.SlideByAction = {previous: "previous", current: "current", next: "next"}
})(window,
    window.klass, window.Code.Util);
(function (d, j, a) {
    a.registerNamespace("Code.PhotoSwipe.Carousel");
    var b = d.Code.PhotoSwipe;
    b.Carousel.CarouselClass = j({
        el: null,
        contentEl: null,
        settings: null,
        cache: null,
        ...
        dispose: function () {
            var c, f, e;
            f = 0;
            for (e = this.cache.images.length; f < e; f++)a.Events.remove(this.cache.images[f], b.Image.EventTypes.onLoad,
        ...
        initialize: function (c, f) {
            ...
            a.DOM.appendChild(this.contentEl,
                this.el);
            i = c.images.length < 3 ? c.images.length : 3;
            for (e = 0; e < i; e++)h = a.DOM.createElement("div", {"class": b.Carousel.CssClasses.item + " " + b.Carousel.CssClasses.item + "-" + e}, ""), a.DOM.setAttribute(h, "style", "float: left;"), a.DOM.setStyle(h, {
                display: "block",
                position: "relative",
                left: 0,
                top: 0,
                overflow: "hidden"
            }), this.settings.margin > 0 && a.DOM.setStyle(h, {marginRight: this.settings.margin + "px"}), a.DOM.appendChild(h, this.contentEl);
            this.settings.target === d ? a.DOM.appendToBody(this.el) : a.DOM.appendChild(this.el, this.settings.target)
        },
        resetPosition: function () {
            var c, f, e, i, h, g;
            this.settings.target === d ? (c = a.DOM.windowWidth(), f = a.DOM.windowHeight(), e = a.DOM.windowScrollTop() + "px") : (c = a.DOM.width(this.settings.target), f = a.DOM.height(this.settings.target), e = "0px");
            i = this.settings.margin > 0 ? c + this.settings.margin : c;
            h = a.DOM.find("." + b.Carousel.CssClasses.item, this.contentEl);
            i *= h.length;
            a.DOM.setStyle(this.el, {top: e, width: c, height: f});
            a.DOM.setStyle(this.contentEl, {width: i, height: f});
            e = 0;
            for (i = h.length; e < i; e++)g = h[e], a.DOM.setStyle(g, {
                width: c,
                height: f
            }), g = a.DOM.find("img", g)[0], a.isNothing(g) || this.resetImagePosition(g);
            this.setContentLeftPosition()
        },
        resetImagePosition: function (c) {
            if (!a.isNothing(c)) {
                a.DOM.getAttribute(c, "src");
                var f, b, d, h = a.DOM.width(this.el), g = a.DOM.height(this.el);
                this.settings.imageScaleMethod === "fitNoUpscale" ? (b = c.naturalWidth, d = c.naturalHeight, b > h && (f = h / b, b = Math.round(b * f), d = Math.round(d * f)), d > g && (f = g / d, d = Math.round(d * f), b = Math.round(b * f))) : (f = c.isLandscape ? h / c.naturalWidth : g / c.naturalHeight, b = Math.round(c.naturalWidth *
                f), d = Math.round(c.naturalHeight * f), this.settings.imageScaleMethod === "zoom" ? (f = 1, d < g ? f = g / d : b < h && (f = h / b), f !== 1 && (b = Math.round(b * f), d = Math.round(d * f))) : this.settings.imageScaleMethod === "fit" && (f = 1, b > h ? f = h / b : d > g && (f = g / d), f !== 1 && (b = Math.round(b * f), d = Math.round(d * f))));
                a.DOM.setStyle(c, {
                    position: "absolute",
                    width: b,
                    height: d,
                    top: Math.round((g - d) / 2) + "px",
                    left: Math.round((h - b) / 2) + "px",
                    display: "block"
                })
            }
        },
        setContentLeftPosition: function () {
            var c, b, e;
            c = this.settings.target === d ? a.DOM.windowWidth() : a.DOM.width(this.settings.target);
            b = this.getItemEls();
            e = 0;
            this.settings.loop ? e = (c + this.settings.margin) * -1 : this.currentCacheIndex === this.cache.images.length - 1 ? e = (b.length - 1) * (c + this.settings.margin) * -1 : this.currentCacheIndex > 0 && (e = (c + this.settings.margin) * -1);
            a.DOM.setStyle(this.contentEl, {left: e + "px"})
        },
        show: function (c) {
            ...
            var c = this.getItemEls(), f, d;
            f = 0;
            for (d = c.length; f < d; f++)a.Animation.resetTranslate(c[f]);
            a.Events.fire(this, {
        ...
        setImages: function (a) {
            ...
            var i = this.currentCacheIndex - 1;
            this.settings.loop ? (b > this.cache.images.length - 1 && (b = 0), i < 0 && (i = this.cache.images.length - 1), b = this.cache.getImages([i, this.currentCacheIndex, b]), a || this.addCacheImageToItemEl(b[1], d[1]), this.addCacheImageToItemEl(b[2], d[2]), this.addCacheImageToItemEl(b[0],
        ...
        slideCarousel: function (c, f, e) {
            if (!this.isSliding) {
                var i, h;
                i = this.settings.target === d ? a.DOM.windowWidth() + this.settings.margin : a.DOM.width(this.settings.target) + this.settings.margin;
                e = a.coalesce(e, this.settings.slideSpeed);
                if (!(d.Math.abs(h) < 1)) {
                    switch (f) {
                        ...
                        case a.TouchElement.ActionTypes.swipeRight:
                            ...
                            break;
                        default:
                            h = c.x - this.touchStartPoint.x, c = d.Math.abs(h) > i / 2 ? h > 0 ? i : i * -1 : 0
                    }
        ...
        startSlideshow: function () {
            ...
            this.slideshowTimeout = d.setTimeout(this.slideshowNext.bind(this), this.settings.slideshowDelay);
            a.Events.fire(this, {type: b.Carousel.EventTypes.onSlideshowStart, target: this})
        },
        stopSlideshow: function () {
            if (!a.isNothing(this.slideshowTimeout))d.clearTimeout(this.slideshowTimeout), this.slideshowTimeout = null, this.isSlideshowActive = !1, a.Events.fire(this, {
        ...
        onTouch: function (c, b) {
            this.stopSlideshow();
            switch (c) {
                case a.TouchElement.ActionTypes.touchStart:
                    this.touchStartPoint = b;
                    this.touchStartPosition = {
                        x: d.parseInt(a.DOM.getStyle(this.contentEl, "left"), 0),
                        y: d.parseInt(a.DOM.getStyle(this.contentEl, "top"), 0)
                    };
                    break;
...
(function (d, j, a) {
    a.registerNamespace("Code.PhotoSwipe.Carousel");
    j = d.Code.PhotoSwipe;
    j.Carousel.CarouselClass = j.Carousel.CarouselClass.extend({
        getStartingPos: function () {
            ...
            a.Browser.isCSSTransformSupported ? (c = {}, c[a.Animation._transitionPrefix + "Property"] = "all", c[a.Animation._transitionPrefix + "Duration"] =
                "", c[a.Animation._transitionPrefix + "TimingFunction"] = "", c[a.Animation._transitionPrefix + "Delay"] = "0", c[a.Animation._transformLabel] = a.Browser.is3dSupported ? "translate3d(" + b + "px, 0px, 0px)" : "translate(" + b + "px, 0px)", a.DOM.setStyle(this.contentEl, c)) : a.isNothing(d.jQuery) || d.jQuery(this.contentEl).stop().css("left", this.getStartingPos().x + b + "px")
        }, doSlideCarousel: function (b, c) {
            var f;
            if (c <= 0)this.slideByEndHandler(); else if (a.Browser.isCSSTransformSupported)f = a.coalesce(this.contentEl.style.webkitTransform,
                this.contentEl.style.MozTransform, this.contentEl.style.transform, ""), f.indexOf("translate3d(" + b) === 0 ? this.slideByEndHandler() : f.indexOf("translate(" + b) === 0 ? this.slideByEndHandler() : a.Animation.slideBy(this.contentEl, b, 0, c, this.slideByEndHandler, this.settings.slideTimingFunction); else if (!a.isNothing(d.jQuery)) {
                f = {left: this.getStartingPos().x + b + "px"};
                if (this.settings.animationTimingFunction === "ease-out")this.settings.animationTimingFunction = "easeOutQuad";
                if (a.isNothing(d.jQuery.easing[this.settings.animationTimingFunction]))this.settings.animationTimingFunction =
                    "linear";
...
(function (d, j, a) {
    ...
    b.Toolbar.ToolbarClass = j({
        ...
        initialize: function (c, f) {
            ...
            this.toolbarEl = a.DOM.createElement("div", {"class": e}, this.settings.getToolbar());
            ...
            this.settings.target === d ? a.DOM.appendToBody(this.toolbarEl) : a.DOM.appendChild(this.toolbarEl, this.settings.target);
            ...
            this.settings.captionAndToolbarFlipPosition && (e = e + " " + b.Toolbar.CssClasses.captionBottom);
            this.captionEl = a.DOM.createElement("div", {"class": e}, "");
            a.DOM.setStyle(this.captionEl,
                {left: 0, position: "absolute", overflow: "hidden", zIndex: this.settings.zIndex});
            this.settings.target === d ? a.DOM.appendToBody(this.captionEl) : a.DOM.appendChild(this.captionEl, this.settings.target);
        ...
        resetPosition: function () {
            var c, b, e;
            this.settings.target === d ? (this.settings.captionAndToolbarFlipPosition ?
                (b = a.DOM.windowScrollTop(), e = a.DOM.windowScrollTop() + a.DOM.windowHeight() - a.DOM.height(this.captionEl)) : (b = a.DOM.windowScrollTop() + a.DOM.windowHeight() - a.DOM.height(this.toolbarEl), e = a.DOM.windowScrollTop()), c = a.DOM.windowWidth()) : (this.settings.captionAndToolbarFlipPosition ? (b = "0", e = a.DOM.height(this.settings.target) - a.DOM.height(this.captionEl)) : (b = a.DOM.height(this.settings.target) - a.DOM.height(this.toolbarEl), e = 0), c = a.DOM.width(this.settings.target));
            a.DOM.setStyle(this.toolbarEl, {
                top: b + "px",
                width: c
            });
            a.DOM.setStyle(this.captionEl, {top: e + "px", width: c})
        },
        ...
        clearTimeout: function () {
            if (!a.isNothing(this.timeout))d.clearTimeout(this.timeout), this.timeout = null
        },
        fadeOut: function () {
            this.clearTimeout();
        ...
        setCaption: function (c) {
            ...
            this.currentCaption = a.coalesce(this.cache.images[c].caption, "\u00a0");
...
(function (d, j, a) {
    ...
    d.Code.PhotoSwipe.UILayer.CssClasses = {uiLayer: "ps-uilayer"}
})(window, window.klass, window.Code.Util);
(function (d, j, a) {
    a.registerNamespace("Code.PhotoSwipe.UILayer");
    var b = d.Code.PhotoSwipe;
    b.UILayer.UILayerClass = a.TouchElement.TouchElementClass.extend({
        el: null, settings: null, dispose: function () {
            ...
            this.settings.target === d ? a.DOM.setStyle(this.el, {
...
(function (d, j, a) {
    ...
    d = d.Code.PhotoSwipe;
    d.ZoomPanRotate.CssClasses = {zoomPanRotate: "ps-zoom-pan-rotate"};
    d.ZoomPanRotate.EventTypes = {onTransform: "PhotoSwipeZoomPanRotateOnTransform"}
})(window, window.klass, window.Code.Util);
(function (d, j, a) {
    a.registerNamespace("Code.PhotoSwipe.ZoomPanRotate");
    var b = d.Code.PhotoSwipe;
    b.ZoomPanRotate.ZoomPanRotateClass = j({
        el: null,
        settings: null,
        containerEl: null,
        imageEl: null,
        ...
        initialize: function (c, f, e) {
            var i, h, g;
            this.settings = c;
            this.settings.target === d ? (c = document.body, i = a.DOM.windowWidth(), h = a.DOM.windowHeight(),
                g = a.DOM.windowScrollTop() + "px") : (c = this.settings.target, i = a.DOM.width(c), h = a.DOM.height(c), g = "0px");
            ...
            a.DOM.insertBefore(this.el, e.el, c);
        ...
        setStartingTranslateFromCurrentTransform: function () {
            ...
            if (!a.isNothing(c) && (c = c.match(/translate\((.*?)\)/), !a.isNothing(c)))c = c[1].split(", "), this.transformSettings.startingTranslateX = d.parseInt(c[0], 10), this.transformSettings.startingTranslateY = d.parseInt(c[1], 10)
        },
        getScale: function (a) {
        ...
        zoomAndPanToPoint: function (b, f) {
            if (this.settings.target === d) {
                this.panStart({x: a.DOM.windowWidth() / 2, y: a.DOM.windowHeight() / 2});
                var e = (f.y - this.panStartingPoint.y) / this.transformSettings.scale;
                this.transformSettings.translateX = (this.transformSettings.startingTranslateX + (f.x - this.panStartingPoint.x) / this.transformSettings.scale) * -1;
                this.transformSettings.translateY = (this.transformSettings.startingTranslateY + e) * -1
            }
        ...
        applyTransform: function () {
            var c = this.transformSettings.rotation % 360, f = d.parseInt(this.transformSettings.translateX, 10),
                e = d.parseInt(this.transformSettings.translateY, 10), i = "scale(" + this.transformSettings.scale + ") rotate(" + c + "deg) translate(" + f + "px, " + e + "px)";
...
(function (d, j) {
    j.registerNamespace("Code.PhotoSwipe");
    var a = d.Code.PhotoSwipe;
    ...
    a.setActivateInstance = function (b) {
        if (j.arrayIndexOf(b.settings.target, a.activeInstances, "target") > -1)throw"Code.PhotoSwipe.activateInstance: Unable to active instance as another instance is already active for this target";
        a.activeInstances.push({target: b.settings.target, instance: b})
    };
    a.unsetActivateInstance = function (b) {
        b = j.arrayIndexOf(b, a.activeInstances, "instance");
        a.activeInstances.splice(b, 1)
    };
    a.attach = function (b, c, d) {
        var e, i;
        e = a.createInstance(b, c, d);
        c = 0;
        for (d =
                 b.length; c < d; c++)if (i = b[c], !j.isNothing(i.nodeType) && i.nodeType === 1)i.__photoSwipeClickHandler = a.onTriggerElementClick.bind(e), j.Events.remove(i, "click", i.__photoSwipeClickHandler), j.Events.add(i, "click", i.__photoSwipeClickHandler);
        return e
    };
    if (d.jQuery)d.jQuery.fn.photoSwipe = function (b, c) {
        return a.attach(this, b, c)
    };
    a.detatch = function (b) {
        var c, d, e;
        c = 0;
        for (d = b.originalImages.length; c < d; c++)e = b.originalImages[c], !j.isNothing(e.nodeType) && e.nodeType === 1 && (j.Events.remove(e, "click", e.__photoSwipeClickHandler),
            delete e.__photoSwipeClickHandler);
        a.disposeInstance(b)
    };
    a.createInstance = function (b, c, d) {
        var e;
        if (j.isNothing(b))throw"Code.PhotoSwipe.attach: No images passed.";
        if (!j.isLikeArray(b))throw"Code.PhotoSwipe.createInstance: Images must be an array of elements or image urls.";
        if (b.length < 1)throw"Code.PhotoSwipe.createInstance: No images to passed.";
        c = j.coalesce(c, {});
        e = a.getInstance(d);
        if (j.isNothing(e))e = new a.PhotoSwipeClass(b, c, d), a.instances.push(e); else throw'Code.PhotoSwipe.createInstance: Instance with id "' +
        d + ' already exists."';
        return e
    };
...
(function (d, j, a, b, c, f, e, i, h) {
    a.registerNamespace("Code.PhotoSwipe");
    var g = d.Code.PhotoSwipe;
    g.PhotoSwipeClass = j({
        id: null,
        settings: null,
        ...
        dispose: function () {
            var b;
            a.Events.remove(this, g.EventTypes.onBeforeShow);
            a.Events.remove(this, g.EventTypes.onShow);
            a.Events.remove(this,
                g.EventTypes.onBeforeHide);
            a.Events.remove(this, g.EventTypes.onHide);
            a.Events.remove(this, g.EventTypes.onDisplayImage);
            a.Events.remove(this, g.EventTypes.onResetPosition);
            a.Events.remove(this, g.EventTypes.onSlideshowStart);
            a.Events.remove(this, g.EventTypes.onSlideshowStop);
            a.Events.remove(this, g.EventTypes.onTouch);
            a.Events.remove(this, g.EventTypes.onBeforeCaptionAndToolbarShow);
            a.Events.remove(this, g.EventTypes.onCaptionAndToolbarShow);
            a.Events.remove(this, g.EventTypes.onBeforeCaptionAndToolbarHide);
            a.Events.remove(this, g.EventTypes.onCaptionAndToolbarHide);
            a.Events.remove(this, g.EventTypes.onZoomPanRotateTransform);
            this.removeEventHandlers();
        ...
        initialize: function (c,
            ...
            if (a.Browser.android && !a.Browser.firefox && d.navigator.userAgent.match(/Android (\d+.\d+)/).toString().replace(/^.*\,/, "") >= 2.1)this.isBackEventSupported = !0;
            if (!this.isBackEventSupported)this.isBackEventSupported = a.objectHasProperty(d, "onhashchange");
            this.settings = {
                fadeInSpeed: 250,
                fadeOutSpeed: 250,
                preventHide: !1,
                ...
                jQueryMobile: !a.isNothing(d.jQuery) && !a.isNothing(d.jQuery.mobile),
                ...
                getToolbar: g.Toolbar.getToolbar,
                allowUserZoom: !0,
                allowRotationOnUserZoom: !1,
                maxUserZoom: 5,
                minUserZoom: 0.5,
                doubleTapZoomLevel: 2.5,
                getImageSource: g.Cache.Functions.getImageSource,
                getImageCaption: g.Cache.Functions.getImageCaption,
                getImageMetaData: g.Cache.Functions.getImageMetaData,
                cacheMode: g.Cache.Mode.normal
            };
            a.extend(this.settings, e);
            this.settings.target !== d && (e = a.DOM.getStyle(this.settings.target,
                "position"), (e !== "relative" || e !== "absolute") && a.DOM.setStyle(this.settings.target, "position", "relative"));
            if (this.settings.target !== d)this.isBackEventSupported = !1, this.settings.backButtonHideEnabled = !1; else if (this.settings.preventHide)this.settings.backButtonHideEnabled = !1;
        ...
        show: function (b) {
            ...
            if (a.isNumber(b))this.currentIndex = b; else {
                this.currentIndex = -1;
                c = 0;
                for (e = this.originalImages.length; c < e; c++)if (this.originalImages[c] ===
                    b) {
                    this.currentIndex = c;
                    break
                }
            ...
            g.setActivateInstance(this);
            this.windowDimensions = this.getWindowDimensions();
            this.settings.target === d ? a.DOM.addClass(d.document.body, g.CssClasses.buildingBody) : a.DOM.addClass(this.settings.target, g.CssClasses.buildingBody);
            this.createComponents();
            a.Events.fire(this, {
                type: g.EventTypes.onBeforeShow,
                target: this
            });
        ...
        createComponents: function () {
            ...
            if (!this.settings.captionAndToolbarHide)this.toolbar = new e.ToolbarClass(this.cache, this.settings)
        },
        resetPosition: function () {
            if (!this._isResettingPosition) {
                ...
                if (a.isNothing(this.windowDimensions) || !(b.width === this.windowDimensions.width && b.height === this.windowDimensions.height))this._isResettingPosition = !0, this.windowDimensions = b, this.destroyZoomPanRotate(), this.documentOverlay.resetPosition(), this.carousel.resetPosition(), a.isNothing(this.toolbar) || this.toolbar.resetPosition(), this.uiLayer.resetPosition(), this._isResettingPosition = !1, a.Events.fire(this, {
                    type: g.EventTypes.onResetPosition,
                    target: this
                })
            }
        },
        ...
        addEventHandlers: function () {
            ...
            a.Browser.android ? this.orientationEventName = "resize" : a.Browser.iOS && !a.Browser.safari ? a.Events.add(d.document.body, "orientationchange", this.windowOrientationChangeHandler) : this.orientationEventName = !a.isNothing(d.onorientationchange) ? "orientationchange" : "resize";
            a.isNothing(this.orientationEventName) || a.Events.add(d, this.orientationEventName, this.windowOrientationChangeHandler);
            this.settings.target === d && a.Events.add(d, "scroll", this.windowScrollHandler);
            this.settings.enableKeyboard &&
            a.Events.add(d.document, "keydown", this.keyDownHandler);
            if (this.isBackEventSupported && this.settings.backButtonHideEnabled)this.windowHashChangeHandler = this.onWindowHashChange.bind(this), this.settings.jQueryMobile ? d.location.hash = this.settings.jQueryMobileDialogHash : (this.currentHistoryHashValue = "PhotoSwipe" + (new Date).getTime().toString(), d.location.hash = this.currentHistoryHashValue), a.Events.add(d, "hashchange", this.windowHashChangeHandler);
            this.settings.enableMouseWheel && a.Events.add(d, "mousewheel",
            ...
            a.isNothing(this.toolbar) || (a.Events.add(this.toolbar, e.EventTypes.onTap, this.toolbarTapHandler), a.Events.add(this.toolbar,
                e.EventTypes.onBeforeShow, this.toolbarBeforeShowHandler), a.Events.add(this.toolbar, e.EventTypes.onShow, this.toolbarShowHandler), a.Events.add(this.toolbar, e.EventTypes.onBeforeHide, this.toolbarBeforeHideHandler), a.Events.add(this.toolbar, e.EventTypes.onHide, this.toolbarHideHandler))
        },
        removeEventHandlers: function () {
            a.Browser.iOS && !a.Browser.safari && a.Events.remove(d.document.body, "orientationchange", this.windowOrientationChangeHandler);
            a.isNothing(this.orientationEventName) || a.Events.remove(d, this.orientationEventName,
                this.windowOrientationChangeHandler);
            a.Events.remove(d, "scroll", this.windowScrollHandler);
            this.settings.enableKeyboard && a.Events.remove(d.document, "keydown", this.keyDownHandler);
            this.isBackEventSupported && this.settings.backButtonHideEnabled && a.Events.remove(d, "hashchange", this.windowHashChangeHandler);
            this.settings.enableMouseWheel && a.Events.remove(d, "mousewheel", this.mouseWheelHandler);
            ...
            a.isNothing(this.toolbar) || (a.Events.remove(this.toolbar, e.EventTypes.onTap, this.toolbarTapHandler), a.Events.remove(this.toolbar, e.EventTypes.onBeforeShow, this.toolbarBeforeShowHandler), a.Events.remove(this.toolbar,
                e.EventTypes.onShow, this.toolbarShowHandler), a.Events.remove(this.toolbar, e.EventTypes.onBeforeHide, this.toolbarBeforeHideHandler), a.Events.remove(this.toolbar, e.EventTypes.onHide, this.toolbarHideHandler))
        },
        hide: function () {
            if (!this.settings.preventHide) {
                ...
                if (a.isNothing(this.hiding)) {
                    ...
                    this.removeEventHandlers();
                    a.Events.fire(this,
                        {type: g.EventTypes.onBeforeHide, target: this});
                    this.uiLayer.dispose();
                    this.uiLayer = null;
                    if (!a.isNothing(this.toolbar))this.toolbar.dispose(), this.toolbar = null;
                    this.carousel.dispose();
                    this.carousel = null;
                    a.DOM.removeClass(d.document.body, g.CssClasses.activeBody);
                    this.documentOverlay.dispose();
                    this.documentOverlay = null;
                    this._isResettingPosition = !1;
                    g.unsetActivateInstance(this);
                    a.Events.fire(this, {type: g.EventTypes.onHide, target: this});
        ...
        goBackInHistory: function () {
            ...
            this.settings.backButtonHideEnabled && (this.backButtonClicked || d.history.back())
        },
        play: function () {
        ...
        createZoomPanRotate: function () {
            this.stop();
            if (this.canUserZoom() && !this.isZoomActive())a.Events.fire(this, g.EventTypes.onBeforeZoomPanRotateShow), this.zoomPanRotate = new h.ZoomPanRotateClass(this.settings,
                this.cache.images[this.currentIndex], this.uiLayer), this.uiLayer.captureSettings.preventDefaultTouchEvents = !0, a.Events.add(this.zoomPanRotate, g.ZoomPanRotate.EventTypes.onTransform, this.zoomPanRotateTransformHandler), a.Events.fire(this, g.EventTypes.onZoomPanRotateShow), !a.isNothing(this.toolbar) && this.toolbar.isVisible && this.toolbar.fadeOut()
        },
        destroyZoomPanRotate: function () {
            if (!a.isNothing(this.zoomPanRotate))a.Events.fire(this, g.EventTypes.onBeforeZoomPanRotateHide), a.Events.remove(this.zoomPanRotate,
                g.ZoomPanRotate.EventTypes.onTransform, this.zoomPanRotateTransformHandler), this.zoomPanRotate.dispose(), this.zoomPanRotate = null, this.uiLayer.captureSettings.preventDefaultTouchEvents = this.settings.preventDefaultTouchEvents, a.Events.fire(this, g.EventTypes.onZoomPanRotateHide)
        },
        ...
        onDocumentOverlayFadeIn: function () {
            d.setTimeout(function () {
                var b = this.settings.target === d ? d.document.body : this.settings.target;
                a.DOM.removeClass(b, g.CssClasses.buildingBody);
                a.DOM.addClass(b, g.CssClasses.activeBody);
                this.addEventHandlers();
                this.carousel.show(this.currentIndex);
                this.uiLayer.show();
                this.settings.autoStartSlideshow ? this.play() : a.isNothing(this.toolbar) || this.toolbar.show(this.currentIndex);
                a.Events.fire(this, {type: g.EventTypes.onShow, target: this});
                this.setUIWebViewResetPositionTimeout()
            }.bind(this), 250)
        },
        setUIWebViewResetPositionTimeout: function () {
            if (this.settings.enableUIWebViewRepositionTimeout && a.Browser.iOS && !a.Browser.safari)a.isNothing(this._uiWebViewResetPositionTimeout) || d.clearTimeout(this._uiWebViewResetPositionTimeout), this._uiWebViewResetPositionTimeout =
                d.setTimeout(function () {
                    this.resetPosition();
                    this.setUIWebViewResetPositionTimeout()
        ...
        clearUIWebViewResetPositionTimeout: function () {
            a.isNothing(this._uiWebViewResetPositionTimeout) || d.clearTimeout(this._uiWebViewResetPositionTimeout)
        },
        ...
        onWindowHashChange: function () {
            if (d.location.hash !== "#" + (this.settings.jQueryMobile ? this.settings.jQueryMobileDialogHash :
        ...
        onUILayerTouch: function (b) {
            if (this.isZoomActive())switch (b.action) {
                ...
                case a.TouchElement.ActionTypes.tap:
                    ...
                    break;
                case a.TouchElement.ActionTypes.doubleTap:
                    this.settings.target === d && (b.point.x -= a.DOM.windowScrollLeft(), b.point.y -= a.DOM.windowScrollTop());
                    var c = this.cache.images[this.currentIndex].imageEl, e = d.parseInt(a.DOM.getStyle(c, "top"), 10), f = d.parseInt(a.DOM.getStyle(c, "left"), 10), h = f + a.DOM.width(c), c = e + a.DOM.height(c);
                    if (b.point.x < f)b.point.x = f; else if (b.point.x > h)b.point.x = h;
                    if (b.point.y < e)b.point.y = e; else if (b.point.y > c)b.point.y = c;
            ...
            a.Events.fire(this, {type: g.EventTypes.onTouch, target: this, point: b.point, action: b.action})
        },
        onCarouselSlideByEnd: function (b) {
            ...
            a.Events.fire(this, {
                type: g.EventTypes.onDisplayImage,
                target: this, action: b.action, index: b.cacheIndex
            })
        },
        onToolbarTap: function (b) {
            switch (b.action) {
                case e.ToolbarAction.next:
                    this.next();
                    break;
                case e.ToolbarAction.previous:
                    this.previous();
                    break;
                case e.ToolbarAction.close:
                    this.hide();
                    break;
                case e.ToolbarAction.play:
                    this.play()
            }
            a.Events.fire(this, {
                type: g.EventTypes.onToolbarTap,
                target: this,
        ...
        onCarouselSlideshowStart: function () {
            a.Events.fire(this, {type: g.EventTypes.onSlideshowStart, target: this})
        },
        onCarouselSlideshowStop: function () {
            a.Events.fire(this, {type: g.EventTypes.onSlideshowStop, target: this})
        },
        onToolbarBeforeShow: function () {
            a.Events.fire(this, {type: g.EventTypes.onBeforeCaptionAndToolbarShow, target: this})
        },
        onToolbarShow: function () {
            a.Events.fire(this, {
                type: g.EventTypes.onCaptionAndToolbarShow,
                target: this
            })
        },
        onToolbarBeforeHide: function () {
            a.Events.fire(this, {type: g.EventTypes.onBeforeCaptionAndToolbarHide, target: this})
        },
        onToolbarHide: function () {
            a.Events.fire(this, {type: g.EventTypes.onCaptionAndToolbarHide, target: this})
        },
        onZoomPanRotateTransform: function (b) {
            a.Events.fire(this, {
                target: this,
                type: g.EventTypes.onZoomPanRotateTransform,
                scale: b.scale,
                rotation: b.rotation,
